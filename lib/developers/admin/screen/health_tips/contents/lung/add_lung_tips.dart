...
class AddLungTips extends StatefulWidget {
  @override
  _AddLungTipsState createState() => _AddLungTipsState();
}

class _AddLungTipsState extends State<AddLungTips> {
  final GlobalKey<FormState> _lungTipsFormKey = GlobalKey();
  ...
  Future uploadFile() async {
    if (!_lungTipsFormKey.currentState.validate()) {
      return;
    }
    _lungTipsFormKey.currentState.save();
  ...
  void initState() {
    super.initState();
    tipsRef = FirebaseFirestore.instance.collection('lungTips');
  }
