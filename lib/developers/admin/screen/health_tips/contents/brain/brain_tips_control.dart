...
import 'package:self_care/developers/admin/screen/health_tips/contents/brain/add_brain_tips.dart';
...
class BrainTipsControl extends StatefulWidget {
  @override
  _BrainTipsControlState createState() => _BrainTipsControlState();
}

class _BrainTipsControlState extends State<BrainTipsControl> {
  final GlobalKey<FormState> _editBrainTipsFormKey = GlobalKey();
  ...
  _editBrainTips(BuildContext context) async {
    return showDialog(
        context: context,
        ...
        builder: (param) {
          return AlertDialog(
              title: Text(
                'Edit Brain Care Tips',
                style: TextStyle(color: textColor, fontWeight: FontWeight.bold),
              ),
              content: StreamBuilder(
                  stream: FirebaseFirestore.instance
                      .collection('brainTips')
                      .snapshots(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => AddBrainTips()));
        },
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('brainTips').snapshots(),
