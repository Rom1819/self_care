...
class AddBrainTips extends StatefulWidget {
  @override
  _AddBrainTipsState createState() => _AddBrainTipsState();
}

class _AddBrainTipsState extends State<AddBrainTips> {
  final GlobalKey<FormState> _brainTipsFormKey = GlobalKey();
  ...
  Future uploadFile() async {
    if (!_brainTipsFormKey.currentState.validate()) {
      return;
    }
    _brainTipsFormKey.currentState.save();
  ...
  void initState() {
    super.initState();
    tipsRef = FirebaseFirestore.instance.collection('brainTips');
  }
