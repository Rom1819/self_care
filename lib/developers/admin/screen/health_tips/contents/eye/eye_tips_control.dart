...
import 'package:self_care/developers/admin/screen/health_tips/contents/eye/add_eye_tips.dart';

import 'package:self_care/models/string_extension.dart';

class EyeTipsControl extends StatefulWidget {
  @override
  _EyeTipsControlState createState() => _EyeTipsControlState();
}

class _EyeTipsControlState extends State<EyeTipsControl> {
  final GlobalKey<FormState> _editEyeTipsFormKey = GlobalKey();
  ...
  _editEyeTips(BuildContext context) async {
    return showDialog(
        context: context,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => AddEyeTips()));
        },
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('eyeTips').snapshots(),
