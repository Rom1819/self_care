...
class AddHeartTips extends StatefulWidget {
  @override
  _AddHeartTipsState createState() => _AddHeartTipsState();
}

class _AddHeartTipsState extends State<AddHeartTips> {
  final GlobalKey<FormState> _heartTipsFormKey = GlobalKey();
  ...
  Future uploadFile() async {
    if (!_heartTipsFormKey.currentState.validate()) {
      return;
    }
    _heartTipsFormKey.currentState.save();
  ...
  void initState() {
    super.initState();
    tipsRef = FirebaseFirestore.instance.collection('heartTips');
  }
