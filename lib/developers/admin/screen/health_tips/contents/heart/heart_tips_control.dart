...
import 'package:self_care/developers/admin/screen/health_tips/contents/heart/add_heart_tips.dart';

import 'package:self_care/models/string_extension.dart';

class HeartTipsControl extends StatefulWidget {
  @override
  _HeartTipsControlState createState() => _HeartTipsControlState();
}

class _HeartTipsControlState extends State<HeartTipsControl> {
  final GlobalKey<FormState> _editHeartTipsFormKey = GlobalKey();
  ...
  _editHeartTips(BuildContext context) async {
    return showDialog(
        context: context,
        ...
        builder: (param) {
          return AlertDialog(
              title: Text(
                'Edit Heart Care Tips',
                style: TextStyle(
                    color: Colors.blueGrey, fontWeight: FontWeight.bold),
              ),
              content: StreamBuilder(
                  stream: FirebaseFirestore.instance
                      .collection('heartTips')
                      .snapshots(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => AddHeartTips()));
        },
      ),
      body: StreamBuilder(
