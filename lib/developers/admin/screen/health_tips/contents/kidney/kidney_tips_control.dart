...
import 'package:self_care/developers/admin/screen/health_tips/contents/kidney/add_kidney_tips.dart';

import 'package:self_care/models/string_extension.dart';

class KidneyTipsControl extends StatefulWidget {
  @override
  _KidneyTipsControlControlState createState() =>
      _KidneyTipsControlControlState();
}

class _KidneyTipsControlControlState extends State<KidneyTipsControl> {
  final GlobalKey<FormState> _editKidneyTipsFormKey = GlobalKey();
  ...
  _editKidneyTips(BuildContext context) async {
    return showDialog(
        context: context,
        ...
        builder: (param) {
          return AlertDialog(
              title: Text(
                'Edit Kidney Care Tips',
                style: TextStyle(
                    color: Colors.blueGrey, fontWeight: FontWeight.bold),
              ),
              content: StreamBuilder(
                  stream: FirebaseFirestore.instance
                      .collection('kidneyTips')
                      .snapshots(),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => AddKidneyTips()));
        },
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('kidneyTips').snapshots(),
