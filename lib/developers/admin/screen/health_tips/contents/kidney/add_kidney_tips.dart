...
class AddKidneyTips extends StatefulWidget {
  @override
  _AddKidneyTipsState createState() => _AddKidneyTipsState();
}

class _AddKidneyTipsState extends State<AddKidneyTips> {
  final GlobalKey<FormState> _kidneyTipsFormKey = GlobalKey();
  ...
  Future uploadFile() async {
    if (!_kidneyTipsFormKey.currentState.validate()) {
      return;
    }
    _kidneyTipsFormKey.currentState.save();
  ...
  void initState() {
    super.initState();
    tipsRef = FirebaseFirestore.instance.collection('kidneyTips');
  }
