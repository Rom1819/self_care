...
import 'package:self_care/developers/admin/screen/health_tips/contents/teeth/add_teeth_tips.dart';
...
class TeethTipsControl extends StatefulWidget {
  @override
  _TeethTipsControlState createState() => _TeethTipsControlState();
}

class _TeethTipsControlState extends State<TeethTipsControl> {
  final GlobalKey<FormState> _editTeethTipsFormKey = GlobalKey();
  ...
  _editTeethTips(BuildContext context) async {
    return showDialog(
        context: context,
        ...
        builder: (param) {
          return AlertDialog(
              title: Text(
                'Edit Teeth Care Tips',
                style: TextStyle(
                    color: Colors.blueGrey, fontWeight: FontWeight.bold),
              ),
              content: StreamBuilder(
                  stream: FirebaseFirestore.instance
                      .collection('teethTips')
                      .snapshots(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => AddTeethTips()));
        },
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('teethTips').snapshots(),
