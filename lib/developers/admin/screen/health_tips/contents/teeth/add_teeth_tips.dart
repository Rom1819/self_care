...
class AddTeethTips extends StatefulWidget {
  @override
  _AddTeethTipsState createState() => _AddTeethTipsState();
}

class _AddTeethTipsState extends State<AddTeethTips> {
  final GlobalKey<FormState> _teethTipsFormKey = GlobalKey();
  ...
  Future uploadFile() async {
    if (!_teethTipsFormKey.currentState.validate()) {
      return;
    }
    _teethTipsFormKey.currentState.save();
  ...
  void initState() {
    super.initState();
    tipsRef = FirebaseFirestore.instance.collection('teethTips');
  }
