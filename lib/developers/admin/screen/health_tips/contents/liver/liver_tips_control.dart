...
import 'package:self_care/developers/admin/screen/health_tips/contents/liver/add_liver_tips.dart';
...
class LiverTipsControl extends StatefulWidget {
  @override
  _LiverTipsControlState createState() => _LiverTipsControlState();
}

class _LiverTipsControlState extends State<LiverTipsControl> {
  final GlobalKey<FormState> _editLiverTipsFormKey = GlobalKey();
  ...
  _editLiverTips(BuildContext context) async {
    return showDialog(
        context: context,
        ...
        builder: (param) {
          return AlertDialog(
              title: Text(
                'Edit Liver Care Tips',
                style: TextStyle(
                    color: Colors.blueGrey, fontWeight: FontWeight.bold),
              ),
              content: StreamBuilder(
                  stream: FirebaseFirestore.instance
                      .collection('liverTips')
                      .snapshots(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => AddLiverTips()));
        },
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('liverTips').snapshots(),
