...
class AddLiverTips extends StatefulWidget {
  @override
  _AddLiverTipsState createState() => _AddLiverTipsState();
}

class _AddLiverTipsState extends State<AddLiverTips> {
  final GlobalKey<FormState> _liverTipsFormKey = GlobalKey();
  ...
  Future uploadFile() async {
    if (!_liverTipsFormKey.currentState.validate()) {
      return;
    }
    _liverTipsFormKey.currentState.save();
  ...
  void initState() {
    super.initState();
    tipsRef = FirebaseFirestore.instance.collection('liverTips');
  }
