...
import 'package:self_care/developers/admin/screen/woman_workout_control/woman_workout_image.dart';
import 'package:self_care/models/string_extension.dart';

class WomanWorkoutControl extends StatefulWidget {
  @override
  _WomanWorkoutControlState createState() => _WomanWorkoutControlState();
}

class _WomanWorkoutControlState extends State<WomanWorkoutControl> {
  final GlobalKey<FormState> _editWomanWorkoutImageFormKey = GlobalKey();
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => WomanWorkoutImage()));
        },
      ),
      body: StreamBuilder(
