...
class KidneyTipsHome extends StatefulWidget {
  @override
  _KidneyTipsHomeControlState createState() => _KidneyTipsHomeControlState();
}

class _KidneyTipsHomeControlState extends State<KidneyTipsHome> {
  @override
